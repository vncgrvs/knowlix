<template>
  ...
  >
    ...
    >
      <div class="w-1/3 border-r p-3 border-gray-800">
      ...
      <div class="w-2/3 p-3 flex justify-center">
        <div class="w-10/12">
        <h3 class="text-center text-gray-800 text-xl font-bold">Welcome to LeanIX <p class="text-lix font-light inline-block">Onboarding</p>  </h3>
          <form
            class="px-8 pt-6 pb-8 rounded flex flex-col justify-center"
          ...
          >
            ...
            <button
              class="w-full p-2 focus:outline-none mt-5 text-lg rounded-full bg-lix-main text-white self-center bg-opacity-90 hover:bg-opacity-100"
            >
              Sign in
            </button>
          </form>
