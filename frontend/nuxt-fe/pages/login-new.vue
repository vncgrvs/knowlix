<template>
  <div class="w-full min-h-screen flex justify-center items-start mt-32  ">
    <div class="w-2/3 h-auto bg-gray-300 p-8 flex flex-row text-black rounded-sm shadow-md">
      <div class="w-1/3 border-r boder p-3 border-gray-800">
        <svg
          viewBox="0 0 507 333"
          version="1.1"
      ...
      <div class="w-2/3 p-3 flex justify-center">
        <div class="w-9/12">
          <form class="px-8 pt-6 pb-8 mb-4 rounded" @submit.prevent="userLogin">
            <label
